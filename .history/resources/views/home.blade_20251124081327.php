                ...
                <div class="col-lg-8 col-12 mx-auto">
                    ...
                    <form method="get" class="custom-form mt-4 pt-2 mb-lg-0 mb-3" action="#" role="search">
                        <div class="input-group input-group-lg">
                            ...
                            <input name="keyword" type="search" class="form-control" id="keyword" placeholder="Cari Berita, Kurikulum, atau Pengumuman..." aria-label="Search">
                            <button type="submit" class="form-control">Cari</button>
                        </div>
                    </form>
                    
                    <div class="text-center mt-4">
                        <a href="{{ route('kontak') }}" class="btn btn-warning custom-btn custom-border-btn me-3">PPDB T.A. 2025/2026 DIBUKA!</a>

                        <a href="{{ route('admin.login') }}" class="btn custom-btn custom-border-btn">Login Admin</a>
                    </div>
                    </div>
            </div>
        </div>
