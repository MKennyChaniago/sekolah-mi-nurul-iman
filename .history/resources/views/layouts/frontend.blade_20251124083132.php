                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav ms-lg-5 me-lg-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link click-scroll" href="#">KESISWAAN</a>
                            </li>
                            
                            <li class="nav-item">
                                <a class="nav-link click-scroll" href="#berita-artikel">BERITA & ARTIKEL</a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link click-scroll" href="#galeri">GALERI</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link click-scroll" href="#contact-section">KONTAK</a>
                            </li>
