...
<html lang="id">
    <head>
        ...
        <link href="{{ asset('css/templatemo-topic-listing.css') }}" rel="stylesheet">
<link href="{{ asset('css/custom-mi.css') }}" rel="stylesheet"> ```

Coba terapkan Langkah 1 (perbaikan struktur HTML dengan menambahkan `d-flex justify-content-center flex-wrap`) terlebih dahulu, dan periksa kembali di *browser*. Ini seringkali cukup untuk memperbaiki *alignment* dan responsivitas tombol di Bootstrap 5.

**Setelah Hero Section kembali responsif, apakah kita lanjutkan ke *template* Login Admin?**
