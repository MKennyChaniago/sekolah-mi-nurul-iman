            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container">
                    ...
                    <div class="d-lg-none ms-auto me-4">
                        <a href="{{ route('login') }}" class="navbar-icon bi-person smoothscroll" title="Login Admin"></a>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 col-6">
                        ...
                        <ul class="site-footer-links">
                            ...
                            <li class="site-footer-link-item"><a href="{{ route('berita.listing') }}" class="site-footer-link">Berita Terbaru</a></li>
                            <li class="site-footer-link-item"><a href="{{ route('kontak') }}" class="site-footer-link">Kontak</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-12 mt-4 mt-lg-0 ms-auto">
                        ...
                        <p class="copyright-text mt-lg-5 mt-4">Copyright © {{ date('Y') }} MI Nurul Iman. All rights reserved.</p>
                    </div>
