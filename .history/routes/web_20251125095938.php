...
Route::get('/admin/guru', function () {
    return view('admin.guru.index'); // Buat file ini nanti
})->name('admin.guru.index');

Route::get('/admin/siswa', function () {
    return view('admin.siswa.index'); // Buat file ini nanti
})->name('admin.siswa.index');

// --- AKADEMIK ---
Route::get('/admin/kurikulum', function () {
    return view('admin.kurikulum.index'); // Buat file ini nanti
})->name('admin.kurikulum.index');

// --- INFORMASI ---
Route::get('/admin/berita', function () {
    return view('admin.berita.index'); // Buat file ini nanti
})->name('admin.berita.index');

Route::get('/admin/pengumuman', function () {
    return view('admin.pengumuman.index'); // Buat file ini nanti
})->name('admin.pengumuman.index');

Route::get('/admin/galeri', function () {
    return view('admin.galeri.index'); // Buat file ini nanti
})->name('admin.galeri.index');

// --- PROFIL SEKOLAH ---
Route::get('/admin/profil-sekolah', function () {
    return view('admin.profil.index'); // Buat file ini nanti
